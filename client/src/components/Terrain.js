...
import splashTerrain from '../assets/splashTerrain.jpg';
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h1 style={{ fontSize: '36pt'}}>Terrain</h1>
          <h2 style={{ fontSize: '20pt'}}>Your Local Environment</h2>
        </div>
      </div>
      <div style={{
        margin: 20,
